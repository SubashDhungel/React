...
const Navbar = (props) => {
  return (
    <div>
       <nav className='navbar navbar-expand-lg bg-body-teritory' style={{ backgroundColor: props.mode === "dark" ? "#0f102c" : 'aliceblue'}}>
  <div className="container-fluid ">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className={`navbar-nav me-auto mb-2 mb-lg-0 text-${props.mode === 'light' ? 'dark' : 'light'}`}>
        ...
        <li className="nav-item">
          <Link className={`nav-link  text-${props.mode === 'light' ? 'dark' : 'light'}`} to="/textform">{props.contact}</Link >
        </li>
